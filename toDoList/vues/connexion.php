...
<head>
    ...
    <link type="text/css" href="style/connexion.css" rel="stylesheet" media="all" /link>
...
<header>
    <nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark">
        ...
        <a class="navbar-brand pl-5" href="accueil.php"><img src="img/TestLogoToDoList1.png" class="rounded float-left" alt="logo To DO List"></a>
